...
{
    public class RestaurantEditVm : IMapFrom<RaterestaurantMVC.Domain.Model.Restaurant>
    {
        ...
        {
            profile.CreateMap<RaterestaurantMVC.Domain.Model.Restaurant, RestaurantEditVm>().ReverseMap();
        }
